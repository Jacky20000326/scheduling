...
const calculateWorkHours = (employee) => {
  ...
  const breakDuration =
    employee.breakStart !== null ? employee.breakEnd - employee.breakStart : 0;
            ...
            <div className="form__grid">
              ...
              <div className="form__row">
                ...
                <input
                  ...
                  {...register("shiftEnd", {
                    required: "請輸入完整的上班時段。",
                    validate: (v) => isHalfHour(v) || "分鐘僅能為 00 或 30。",
                  })}
                />
                {errors.shiftEnd && (
                  <p className="form__error" role="alert">
        ...
        <section className="panel panel--stretch">
          <div className="chart">
            <div className="chart__header">
              ...
              <div
                className="chart__hours-container chart__hours-container--header"
                ref={headerScrollRef}
              >
